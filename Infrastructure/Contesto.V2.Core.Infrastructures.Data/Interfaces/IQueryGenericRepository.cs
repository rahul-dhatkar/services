...
namespace Contesto.V2.Core.Infrastructure.Data.Interfaces
{
    ...
    public interface IQueryGenericRepository<T>
    {
        ...
        /// <returns></returns>
        Task<Tuple<List<T>, int>> GetAllWithPaging(string SortColumn, string SortDirection, int? pageIndex, int? pageSize, string searchTxt);
        ...
        /// <param name="searchTxt">The search text.</param>
        /// <returns></returns>
        Task<Tuple<List<TSummary>, int>> GetGridSummaryDataWithPaging<TSummary>(string SortColumn, string SortDirection, int? pageIndex, int? pageSize, string searchTxt);
        ...
        /// <param name="searchTxt">The search text.</param>
        /// <returns></returns>
        Task<List<T>> GetAllData(string searchTxt = null);
        ...
        /// <param name="id">The identifier.</param>
        /// <returns></returns>
        Task<IModel> GetById<IModel>(long id);
    }
}